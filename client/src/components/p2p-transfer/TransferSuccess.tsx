  ...
  return (
    <div className="max-w-xl mx-auto mt-8 animate-in zoom-in duration-500">
      <div className="bg-white rounded-3xl border border-slate-200 shadow-xl overflow-hidden print:border-none print:shadow-none">
        {/* Header Section */}
        <div className="bg-linear-to-br from-emerald-50 to-white px-8 pt-10 pb-8 flex flex-col items-center justify-center border-b border-slate-100">
        ...
        <div className="p-8 space-y-6 bg-slate-50/50">
          <div
            id="receipt-card"
            className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-5 relative overflow-hidden"
          >
            {/* Stamp decoration */}
            ...
            <div className="space-y-4 pt-2 relative z-10">
              ...
              {description && (
                <div className="flex justify-between items-start text-sm pt-4 border-t border-slate-100 mt-2">
                  ...
                  <span className="font-medium text-slate-700 text-right max-w-[60%] italic">
                    "{description}"
                  </span>
                </div>
              )}
